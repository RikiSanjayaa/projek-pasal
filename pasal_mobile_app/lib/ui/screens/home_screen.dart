...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _initData() {
    final rawUU = DataService.getAllUU();
    final uniqueIds = <String>{};
    _listUU = rawUU.where((uu) => uniqueIds.add(uu.id)).toList();

    _allPasalCache = DataService.getAllPasal();
  ...
  Future<void> _manualSync() async {
    ...
    if (mounted) {
      ...
      if (success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Gagal sync."), backgroundColor: Colors.red));
      }
    }
  }
    ...
    if (_searchKeyword.isNotEmpty) {
      source = source.where((p) {
        return p.nomor.toLowerCase().contains(_searchKeyword.toLowerCase()) ||
               ...
               p.keywords.any((k) => k.toLowerCase().contains(_searchKeyword.toLowerCase()));
      }).toList();
    }
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: const [
                      SizedBox(height: 4),
                      Text("Jelajahi Pasal", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  _isSyncing 
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  ..._listUU.map((uu) => _buildFilterChip(uu.kode, uu.id)).toList(),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text("Pasal Terbaru", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                           Navigator.push(context, MaterialPageRoute(builder: (_) => ReadPasalScreen(
                             pasal: pasal, 
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(kodeUU, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.blue)),
                              ),
